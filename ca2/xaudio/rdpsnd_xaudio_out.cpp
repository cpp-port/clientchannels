...
/*imedia_time xaudio_out::GetPositionMillisForSynch()
{
...
/*imedia_time xaudio_out::get_position_for_synch()
{
...
//void xaudio_out::out_free(int iBuffer)
//{
//
...
//void xaudio_out::out_on_playback_end()
//{
//
//   out_stop();
//
...
//int32_t xaudio_out::out_get_buffered_buffer_count()
//{
//
//   return ::audio::xaudio_out::out_get_buffered_buffer_count();
//
//}


//WAVEFORMATEX * xaudio_out::wave_format()
//{
//
...
//void * xaudio_out::get_os_data()
//{
//   return m_psourcevoice;
//}
//
//
//void xaudio_out::out_run_step()
//{
//
//   int iPlay =  -1;
//
...
//
void xaudio_out::OnVoiceProcessingPassStart(UINT32 /*bytesRequired*/)
{
}
void xaudio_out::OnVoiceProcessingPassEnd()
{
}

void xaudio_out::OnBufferStart(void* pBufferContext)
{
...
void xaudio_out::OnBufferEnd(void* pBufferContext)
{
...
void xaudio_out::OnLoopEnd(void* /*bufferContext*/)
{
}
void xaudio_out::OnVoiceError(void* /*bufferContext*/,HRESULT /*error*/)
{
}
...
extern "C"
{
      ...
      )
   {
      *phwo = new xaudio_out();
      ...
      return (*phwo)->out_open_ex(0,0,pwfx->nSamplesPerSec,
         pwfx->nChannels,
         pwfx->wBitsPerSample);
