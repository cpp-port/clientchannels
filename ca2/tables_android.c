...
extern BOOL VCAPITYPE cliprdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE drdynvc_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE encomsp_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE rail_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE rdpdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE rdpsnd_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
extern BOOL VCAPITYPE remdesk_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID);
...
const STATIC_ENTRY CLIENT_DeviceServiceEntry_TABLE[] =
{
   ...
   { "drive", (UINT(*)())drive_DeviceServiceEntry },
   { "smartcard",(UINT(*)()) smartcard_DeviceServiceEntry },
   { NULL, {NULL} }
};
...
{
   { "audin", (UINT(*)()) audin_DVCPluginEntry, CLIENT_AUDIN_SUBSYSTEM_TABLE },
   { "cliprdr",(UINT(*)()) cliprdr_VirtualChannelEntryEx, CLIENT_CLIPRDR_SUBSYSTEM_TABLE },
   { "disp",(UINT(*)()) disp_DVCPluginEntry, CLIENT_DISP_SUBSYSTEM_TABLE },
   { "drdynvc", (UINT(*)()) drdynvc_VirtualChannelEntryEx, CLIENT_DRDYNVC_SUBSYSTEM_TABLE },
   { "drive", (UINT(*)()) drive_DeviceServiceEntry, CLIENT_DRIVE_SUBSYSTEM_TABLE },
   { "echo", (UINT(*)()) echo_DVCPluginEntry, CLIENT_ECHO_SUBSYSTEM_TABLE },
   ...
   { "rdpei", (UINT(*)()) rdpei_DVCPluginEntry, CLIENT_RDPEI_SUBSYSTEM_TABLE },
   { "rdpgfx",(UINT(*)()) rdpgfx_DVCPluginEntry, CLIENT_RDPGFX_SUBSYSTEM_TABLE },
   ...
   { "smartcard", (UINT(*)())smartcard_DeviceServiceEntry, CLIENT_SMARTCARD_SUBSYSTEM_TABLE },
   { NULL, {NULL}, NULL }
};
