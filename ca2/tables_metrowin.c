...
//extern void xaudio_freerdp_audin_client_subsystem_entry();
//extern void xaudio_freerdp_rdpsnd_client_subsystem_entry();


const STATIC_SUBSYSTEM_ENTRY CLIENT_AUDIN_SUBSYSTEM_TABLE[] =
{
//   {"xaudio", "", xaudio_freerdp_audin_client_subsystem_entry},
   {NULL, NULL, NULL}
};
...
{
//   {"xaudio", "", xaudio_freerdp_rdpsnd_client_subsystem_entry},
   {NULL, NULL, NULL}
};
