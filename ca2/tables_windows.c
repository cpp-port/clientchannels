...
extern UINT VCAPITYPE cliprdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE drdynvc_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE encomsp_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE rail_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE rdpdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE rdpsnd_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
extern UINT VCAPITYPE remdesk_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS_EX, PVOID pInitHandle);
