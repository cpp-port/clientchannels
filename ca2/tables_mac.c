...
extern BOOL VCAPITYPE cliprdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE drdynvc_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE encomsp_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE rail_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE rdpdr_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE rdpsnd_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);
extern BOOL VCAPITYPE remdesk_VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS);

//extern void drive_DeviceServiceEntryEx();
...
const STATIC_ENTRY CLIENT_DeviceServiceEntryEx_TABLE[] =
{

//	{ "drive", drive_DeviceServiceEntryEx },
...
const STATIC_ENTRY_TABLE CLIENT_STATIC_ENTRY_TABLES[] =
{
	...
	{ "DeviceServiceEntry", CLIENT_DeviceServiceEntryEx_TABLE },
	{ NULL, NULL }
};


//extern void winmm_freerdp_audin_client_subsystem_entry();
extern void mac_freerdp_rdpsnd_client_subsystem_entry();
...
{
	{ "mac", "", mac_freerdp_rdpsnd_client_subsystem_entry },
	{ NULL, NULL, NULL }
};
...
//	{ "drive", drive_DeviceServiceEntryEx, CLIENT_DRIVE_SUBSYSTEM_TABLE },
